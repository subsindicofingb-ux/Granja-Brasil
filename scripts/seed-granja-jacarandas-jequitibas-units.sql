-- =============================================================================
-- Cadastrar unidades 101–304 em Jacarandás e Jequitibás.
--
-- Layout: 3 andares × 4 aptos
--   101–104, 201–204, 301–304  (12 unidades)
--
...
begin
  for condo in
    ...
    where name ilike '%jacarand%' or name ilike '%jequitib%'
    order by name
  loop
    condo_created := 0;
    ...
    raise notice '%: % unidades novas (12 esperadas: 101–304).', condo.name, condo_created;
  end loop;
end $$;
